...
import {Caption, FAB, IconButton,Drawer, Portal} from "react-native-paper"
    ...
    <View style={styles.container}>
      ...
      <View style={styles.bttn}>
       <IconButton icon="keyboard-backspace" style={{marginTop:20,marginLeft:0}}  onPress={()=>{
        ...
        <Text style={styles.time}>General</Text>
      ...
      <Drawer.Section style={{marginTop:5}} >
                   <Text style={{color:'wheat',fontSize:16,marginLeft:75}}>Profile</Text>
                   <DrawerItem onPress={()=>showDialog(true)} label="Set Username" labelStyle={{color:"white",marginLeft:55,fontSize:16}}>
